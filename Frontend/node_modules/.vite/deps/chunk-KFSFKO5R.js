...
var Tooltip = React5.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React5.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime4.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime4.jsxs)(React5.Fragment, {
    children: [React5.cloneElement(children, childrenProps), (0, import_jsx_runtime4.jsx)(PopperSlot, {
...
true ? Tooltip.propTypes = {
   ...
   * @default 'bottom'
   */
  placement: import_prop_types5.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
...
//# sourceMappingURL=chunk-KFSFKO5R.js.map
